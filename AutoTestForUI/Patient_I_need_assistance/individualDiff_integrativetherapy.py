...
def select_integrative_therapy():
    ...
    slider_down()
    time.sleep(1)
    driver.find_element(by=AppiumBy.ACCESSIBILITY_ID, value="Somewhat").click()
    slider_down()
    time.sleep(1)
...
select_integrative_therapy()

# Screen's title check
print(isDisplayed("Integrative Therapy "))
