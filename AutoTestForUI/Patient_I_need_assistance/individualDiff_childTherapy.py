...
# therapy screen have special steps to reach it
def select_therapy():
    driver.find_element(by=AppiumBy.ACCESSIBILITY_ID, value="Individual difficulties").click()
    time.sleep(1)
    driver.find_element(by=AppiumBy.ACCESSIBILITY_ID, value="A child (under 18)").click()
    time.sleep(1)
    slider_down()
...
print(isDisplayed("Child Therapy"))
